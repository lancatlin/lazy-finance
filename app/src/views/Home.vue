        ...
        <div>
            ...
            <div class="flex flex-wrap -mx-3 mb-2" v-for="account, index in accounts" v-key="index">
                <div class="w-full md:w-1/4 px-3 mb-6 md:mb-0">
                    <label :for="`account-${index}-name`" class="block mb-2 text-md font-medium text-gray-900">Account {{
                        index + 1
                    }}</label>
                ...
                <div class="w-full md:w-1/4 px-3 mb-6 md:mb-0">
                    <label :for="`account-${index}-amount`"
                        class="block mb-2 text-md font-medium text-gray-900">Amount</label>
                ...
                <div class="w-full md:w-1/4 px-3 mb-6 md:mb-0">
                    <label :for="`account-${index}-comodity`"
                        class="block mb-2 text-md font-medium text-gray-900">Commodity</label>
